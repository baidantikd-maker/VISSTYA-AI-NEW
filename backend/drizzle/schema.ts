...
export const statusBandEnum = pgEnum("status_band", [
  "FALSE",
  "AVERAGE",
  "TRUSTABLE",
]);
...
export const verificationReports = pgTable("verification_reports", {
  ...
  metadataScore: numeric("metadataScore", { precision: 5, scale: 2 }).default(
    "0"
  ),
  visionScore: numeric("visionScore", { precision: 5, scale: 2 }).default("0"),
  weatherScore: numeric("weatherScore", { precision: 5, scale: 2 }).default(
    "0"
  ),
  evidenceScore: numeric("evidenceScore", { precision: 5, scale: 2 }).default(
    "0"
  ),
